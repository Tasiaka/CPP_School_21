...
static GameApi gSnake  { &userInput,               &updateCurrentState,      "Snake",  GameKind::Snake  };
static GameApi gTetris { &TetrisUserInput,         &TetrisUpdateCurrentState,"Tetris", GameKind::Tetris };
